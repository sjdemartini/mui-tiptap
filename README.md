...
| [`@tiptap/extension-text-style`](https://tiptap.dev/docs/editor/extensions/functionality/line-height)'s `LineHeight`               | `MenuSelectLineHeight` (use the `options` prop to override the default line height options)                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
